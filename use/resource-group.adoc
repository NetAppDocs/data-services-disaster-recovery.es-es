...
[role="lead"]
Después de añadir sitios de recursos, puedes crear grupos de recursos para agrupar máquinas virtuales, almacenes de datos o clústeres de Kubernetes como una sola unidad. Los grupos de recursos te permiten organizar un conjunto de recursos dependientes en grupos lógicos que cumplan tus requisitos. Por ejemplo, podrías agrupar máquinas virtuales asociadas con una aplicación o podrías agrupar aplicaciones que tengan niveles similares. Como otro ejemplo, los grupos podrían contener órdenes de arranque retardado que se pueden ejecutar al momento de la recuperación.
...
* Mientras creas un plan de recuperación ante desastres o un _plan de replicación_. Si tienes muchas máquinas virtuales alojadas en un clúster de origen vCenter, puede que te resulte más sencillo crear los grupos de recursos mientras creas el plan de replicación. Para ver instrucciones sobre cómo crear grupos de recursos mientras creas un plan de replicación, consulta link:drplan-create.html["Crear un plan de replicación"].
...
. En el menú desplegable, filtra por grupos de recursos de *vCenter*.
+
...
.Pasos
. En Disaster Recovery, selecciona **Resource groups** en la barra lateral.
. En el menú desplegable, filtra por sitios *Kubernetes*.
+
image::site-type-toggle.png[Captura de pantalla del conmutador de tipo de sitio]
...
+
image:kubernetes-resource-group.png["Añade un grupo de recursos de Kubernetes"]
