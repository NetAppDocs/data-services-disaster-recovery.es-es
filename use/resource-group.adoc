...
[role="lead"]
Después de que hayas añadido los sitios vCenter, puedes crear grupos de recursos para agrupar máquinas virtuales o almacenes de datos como una sola unidad. Los grupos de recursos te permiten organizar un conjunto de máquinas virtuales dependientes en grupos lógicos que cumplan tus requisitos. Por ejemplo, podrías agrupar máquinas virtuales asociadas con una aplicación o podrías agrupar aplicaciones que tengan niveles similares. Como otro ejemplo, los grupos podrían contener órdenes de arranque retrasado que se pueden ejecutar al momento de la recuperación.
...
Los grupos de recursos te permiten combinar máquinas virtuales o almacenes de datos en una sola unidad.
