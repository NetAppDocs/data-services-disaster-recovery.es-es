...
* *Conservar la jerarquía de carpetas original*: cuando se selecciona, la recuperación ante desastres conserva la jerarquía de inventario de la máquina virtual (estructura de carpetas) en caso de conmutación por error.  Si el destino de recuperación _no_ tiene la jerarquía de carpetas original, se crea la recuperación ante desastres.
+
