...
Seleccione la asignación de red a la LAN virtual adecuada.  Las LAN virtuales ya deberían estar aprovisionadas, así que seleccione la LAN virtual adecuada para asignar la VM.
