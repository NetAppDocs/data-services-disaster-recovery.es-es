...
+
Si es la primera vez que usas NetApp Disaster recovery, necesitas añadir información de vCenter. Si ya añadiste información de vCenter, verás el dashboard.
