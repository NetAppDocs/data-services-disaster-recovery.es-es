...
TIP: Asegúrese de que tanto el vCenter de origen como el de destino utilicen el mismo agente de consola de NetApp .
...
.Pasos
. En el menú Recuperación ante desastres de NetApp , seleccione *Sitios*.
