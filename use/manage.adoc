...
[role="lead"]
Puede obtener un vistazo rápido de todos sus recursos de NetApp Disaster Recovery o ver cada uno en detalle:
...
. Para realizar acciones con el grupo de recursos, seleccione la opción *Acciones*image:../use/icon-horizontal-dots.png["Icono del menú Acciones en el servicio NetApp Disaster Recovery"] a la derecha y seleccione cualquiera de las opciones, como *Editar grupo de recursos* o *Eliminar grupo de recursos*.
...
. De la lista de planes de replicación, seleccione la opción *Acciones*image:../use/icon-horizontal-dots.png["Icono del menú Acciones en el servicio NetApp Disaster Recovery"] a la derecha del plan y seleccione *Reconciliar instantáneas*.
...
. Cambiar el valor del recuento de retención en el plan de replicación.
