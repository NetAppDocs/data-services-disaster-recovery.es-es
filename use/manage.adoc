...
summary: Puede obtener una vista rápida de todos sus recursos de recuperación ante desastres de NetApp y administrar sitios de vCenter, grupos de recursos y planes de replicación. 
---
