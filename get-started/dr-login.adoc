...
summary: Comience a utilizar NetApp Disaster Recovery accediendo al servicio en la consola de NetApp . 
---
...
+
** Si aún no ha agregado un agente de consola de NetApp , deberá agregar uno.  Para agregar el agente, consulte https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["Obtenga más información sobre los agentes de consola"^] .
