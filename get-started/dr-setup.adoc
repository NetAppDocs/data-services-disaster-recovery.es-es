...
[role="lead"]
Para usar NetApp Disaster Recovery, realiza algunos pasos para configurarlo tanto en la NetApp Console como en el entorno de recuperación de desastres compatible.
...
* *VPN de sitio de AWS*: Esta conexión de red privada virtual se puede utilizar para proporcionar conexiones de acceso seguro junto con un proveedor de servicios de Internet público. La VPN cifra y descifra todos los datos que viajan hacia y desde la nube de AWS. Las VPN pueden estar basadas en software o hardware. Para aplicaciones empresariales, el proveedor de servicios de Internet público (ISP) debe ofrecer garantías de calidad de servicio para asegurar que se proporcionen el ancho de banda y la latencia adecuados para la replicación de DR.
