...
.¿Qué es un AppVault?
Un AppVault es el destino de almacenamiento en la nube donde Trident Protect guarda los datos de protección de Kubernetes. Tú creas un AppVault mientras configuras un plan de replicación de Kubernetes. También puedes gestionar AppVaults en la página de Configuración.
