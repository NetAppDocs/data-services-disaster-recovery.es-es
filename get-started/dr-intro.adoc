...
[role="lead"]
La recuperación de desastres en la nube es una forma resistente y rentable de proteger las cargas de trabajo frente a interrupciones del sitio y eventos de corrupción de datos. Con NetApp Disaster Recovery, puedes replicar tus cargas de trabajo VMware VM o datastore locales que se ejecutan en almacenamiento ONTAP a un centro de datos definido por software de VMware en una nube pública usando almacenamiento en la nube de NetApp o a otro entorno VMware local con almacenamiento ONTAP como sitio de recuperación de desastres. También puedes usar Disaster Recovery para migrar cargas de trabajo VM de un sitio a otro.

NetApp Disaster Recovery es un servicio de recuperación de desastres basado en cloud que automatiza los flujos de trabajo de recuperación de desastres. Con NetApp Disaster Recovery, puedes proteger tus clústeres de Kubernetes locales, cargas de trabajo basadas en NFS y almacenes de datos del sistema de archivos de máquinas virtuales (VMFS) de VMware vSphere para iSCSI y FC que ejecutan almacenamiento NetApp hacia uno de los siguientes:
...
Disaster Recovery utiliza los siguientes componentes para proporcionar cargas de trabajo de Disaster Recovery:
