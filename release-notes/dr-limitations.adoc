...
. En el agente de la consola de NetApp , use las opciones de conectividad de su proveedor de nube, conéctese a la máquina virtual Linux en la que se ejecuta el agente de la consola, reinicie el servicio "occm" usando el `docker restart occm` dominio.
...
. En la página Sistemas de consola de NetApp , agregue nuevamente el sistema Amazon FSx para ONTAP y proporcione las credenciales de FSx.
+
