...
summary: Descripción general de la solución de recuperación ante desastres de NetApp mediante Amazon EVS y Amazon FSxN. 
---
...
. El agente de recuperación ante desastres de NetApp se comunica de forma segura con el servicio alojado en la nube de la consola de NetApp para recibir tareas y distribuirlas a las instancias de almacenamiento locales adecuadas, alojadas en AWS y vCenter y ONTAP .
...
. En caso de falla del sitio principal, un administrador inicia un proceso de conmutación por error manual dentro de la consola de NetApp y selecciona una copia de seguridad para usar como punto de restauración.
. El agente de recuperación ante desastres de NetApp activa FSx para volúmenes de protección de datos alojados en ONTAP .
