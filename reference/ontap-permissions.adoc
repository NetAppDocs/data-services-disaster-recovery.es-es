...
[role="lead"]
Configura los permisos necesarios de ONTAP para que NetApp Disaster Recovery funcione correctamente.
...
La recuperación ante desastres requiere los siguientes permisos de ONTAP:
...
Para añadir permisos en ONTAP, crea un rol con los privilegios necesarios y asígnalo a un usuario. Puedes realizar esta tarea en ONTAP con System Manager o la CLI de ONTAP.
