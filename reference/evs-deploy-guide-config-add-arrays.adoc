...
summary: Antes de utilizar NetApp Disaster Recovery, debe agregar instancias de almacenamiento alojadas en la nube y locales al sistema de consola de NetApp . 
---
...
. Desde la página Sistemas de consola de NetApp , seleccione *Agregar sistema*.
+
